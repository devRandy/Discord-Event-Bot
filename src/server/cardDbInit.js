...
const CardData = require('../database/models/card-model.js')(sequelize, Sequelize.DataTypes);
...
sequelize.sync({ force }).then(async () => {
	const shop = [
        ...
        CardData.upsert({ card_name: 'I Bulbasaur', card_id: 166, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Ivysaur', card_id: 167, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Charmander', card_id: 168, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Charmeleon', card_id: 169, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Squirtle', card_id: 170, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Wartortle', card_id: 171, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Caterpie', card_id: 172, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Pikachu', card_id: 173, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Nidoking', card_id: 174, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Psyduck', card_id: 175, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Poliwhirl', card_id: 176, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Machoke', card_id: 177, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Tangela', card_id: 178, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Mr.Mime', card_id: 179, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Omanyte', card_id: 180, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Dragonair', card_id: 181, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Venusaur ex', card_id: 182, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Charizard es', card_id: 183, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Blastoise ex', card_id: 184, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Arbok ex', card_id: 185, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Ninetales ex', card_id: 186, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Wigglytuff ex', card_id: 187, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Alakazam ex', card_id: 188, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Golem ex', card_id: 189, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Kangaskhan ex', card_id: 190, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Jynx ex', card_id: 191, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Zapdos ex', card_id: 192, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Mew ex', card_id: 193, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Bills Transfer', card_id: 194, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Daisys Help', card_id: 195, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Erikas Invitation', card_id: 196, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'I Giovannis Charisma', card_id: 197, card_rarity: 'Super'}),
        CardData.upsert({ card_name: 'P Venusaur ex', card_id: 198, card_rarity: 'Ultra'}),
        CardData.upsert({ card_name: 'P Charizard ex', card_id: 199, card_rarity: 'Ultra'}),
        CardData.upsert({ card_name: 'P Blastoise ex', card_id: 200, card_rarity: 'Ultra'}),
        CardData.upsert({ card_name: 'P Alakazam ex', card_id: 201, card_rarity: 'Ultra'}),
